...
const countries: CountryInterface[] = [
  ...
  { name: "Bangladesh", dial_code: "+880", code: "BD", flag: "🇧🇩", local_name: "বাংলাদেশ" },
  ...
  { name: "Benin", dial_code: "+229", code: "BJ", flag: "🇧🇯", local_name: "Bénin" },
  { name: "Bermuda", dial_code: "+1441", code: "BM", flag: "🇧🇲" },
  { name: "Bhutan", dial_code: "+975", code: "BT", flag: "🇧🇹", local_name: "འབྲུག་ཡུལ" },
  ...
  { name: "Brunei Darussalam", dial_code: "+673", code: "BN", flag: "🇧🇳", local_name: "بروني" },
  ...
  { name: "China", dial_code: "+86", code: "CN", flag: "🇨🇳", local_name: "中国" },
  ...
  { name: "Cote d'Ivoire", dial_code: "+225", code: "CI", flag: "🇨🇮", local_name: "Côte d'Ivoire" },
  { name: "Croatia", dial_code: "+385", code: "HR", flag: "🇭🇷", local_name: "Hrvatska" },
  { name: "Cuba", dial_code: "+53", code: "CU", flag: "🇨🇺" },
  { name: "Cyprus", dial_code: "+357", code: "CY", flag: "🇨🇾" },
  { name: "Czech Republic", dial_code: "+420", code: "CZ", flag: "🇨🇿", local_name: "Česko" },
  ...
  { name: "Djibouti", dial_code: "+253", code: "DJ", flag: "🇩🇯", local_name: "جيبوتي" },
  ...
  { name: "Egypt", dial_code: "+20", code: "EG", flag: "🇪🇬", local_name: "مصر" },
  ...
  { name: "Ethiopia", dial_code: "+251", code: "ET", flag: "🇪🇹", local_name: "ኢትዮጵያ" },
  ...
  { name: "Georgia", dial_code: "+995", code: "GE", flag: "🇬🇪", local_name: "საქართველო" },
  { name: "Germany", dial_code: "+49", code: "DE", flag: "🇩🇪" },
  { name: "Ghana", dial_code: "+233", code: "GH", flag: "🇬🇭" },
  { name: "Gibraltar", dial_code: "+350", code: "GI", flag: "🇬🇮" },
  { name: "Greece", dial_code: "+30", code: "GR", flag: "🇬🇷", local_name: "Ελλάς" },
  ...
  { name: "Hong Kong", dial_code: "+852", code: "HK", flag: "🇭🇰", local_name: "香港" },
  { name: "Hungary", dial_code: "+36", code: "HU", flag: "🇭🇺", local_name: "Magyarország" },
  { name: "Iceland", dial_code: "+354", code: "IS", flag: "🇮🇸", local_name: "Ísland" },
  { name: "India", dial_code: "+91", code: "IN", preferred: true, flag: "🇮🇳", local_name: "भारत" },
  ...
  { name: "Iraq", dial_code: "+964", code: "IQ", flag: "🇮🇶", local_name: "العراق" },
  { name: "Ireland", dial_code: "+353", code: "IE", flag: "🇮🇪", local_name: "Éire" },
  { name: "Isle of Man", dial_code: "+44", code: "IM", flag: "🇮🇲" },
  { name: "Israel", dial_code: "+972", code: "IL", flag: "🇮🇱" },
  { name: "Italy", dial_code: "+39", code: "IT", flag: "🇮🇹", local_name: "Italia" },
  {
    name: "Jamaica",
    dial_code: "+1876",
    code: "JM",
  ...
  { name: "Japan", dial_code: "+81", code: "JP", flag: "🇯🇵", local_name: "日本" },
  { name: "Jersey", dial_code: "+44", code: "JE", flag: "🇯🇪" },
  { name: "Jordan", dial_code: "+962", code: "JO", flag: "🇯🇴", local_name: "الأردن" },
  ...
  { name: "Mozambique", dial_code: "+258", code: "MZ", flag: "🇲🇿", local_name: "Moçambique" },
  { name: "Myanmar", dial_code: "+95", code: "MM", flag: "🇲🇲", local_name: "မြန်မာ" },
  { name: "Namibia", dial_code: "+264", code: "NA", flag: "🇳🇦" },
  { name: "Nauru", dial_code: "+674", code: "NR", flag: "🇳🇷" },
  { name: "Nepal", dial_code: "+977", code: "NP", flag: "🇳🇵", local_name: "नेपाल" },
  ...
  { name: "Norway", dial_code: "+47", code: "NO", flag: "🇳🇴", local_name: "Norge" },
  { name: "Oman", dial_code: "+968", code: "OM", flag: "🇴🇲", local_name: "عُمان" },
  { name: "Pakistan", dial_code: "+92", code: "PK", flag: "🇵🇰", local_name: "پاکستان" },
  ...
  { name: "Qatar", dial_code: "+974", code: "QA", flag: "🇶🇦", local_name: "قطر" },
  { name: "Romania", dial_code: "+40", code: "RO", flag: "🇷🇴" },
  { name: "Russia", dial_code: "+7", code: "RU", flag: "🇷🇺", local_name: "Россия" },
  ...
  { name: "Somalia", dial_code: "+252", code: "SO", flag: "🇸🇴", local_name: "الصومال" },
  ...
  { name: "Sri Lanka", dial_code: "+94", code: "LK", flag: "🇱🇰", local_name: "ශ්‍රී ලංකාව" },
  { name: "Sudan", dial_code: "+249", code: "SD", flag: "🇸🇩", local_name: "السودان" },
  ...
  { name: "Syrian Arab Republic", dial_code: "+963", code: "SY", flag: "🇸🇾", local_name: "سورية" },
  ...
  { name: "Thailand", dial_code: "+66", code: "TH", flag: "🇹🇭", local_name: "เมืองไทย" },
  ...
  { name: "Tunisia", dial_code: "+216", code: "TN", flag: "🇹🇳", local_name: "تونس" },
